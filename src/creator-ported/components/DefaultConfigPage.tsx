...
export function DefaultConfigPage({ onBack, gameType = 'tagquest' }: DefaultConfigPageProps) {
  const [config, setConfig] = useState<DefaultConfig>({
    ...
    text_card_not_empty: 'La puce n\'est pas vide',
    text_team_starts_card_not_empty: 'L\'équipe démarre avec une puce non vide',
    text_card_not_corresponding: 'Puce non reconnue',
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-white">
              Default Configuration - {gameType === 'tagquest' ? 'TagQuest' : gameType === 'mystery' ? 'Mystery' : 'Track'}
            </h1>
