  ...
  ingame_common: [
    {
      ...
      charLimit: 40,
      seed: { en: 'Card not recognized', fr: 'Carte non reconnue', es: 'Tarjeta no reconocida', de: 'Karte nicht erkannt', it: 'Tessera non riconosciuta', pt: 'Cartão não reconhecido' },
    },
    {
    ...
    },
    {
      ...
      charLimit: 40,
      seed: { en: 'Card not registered', fr: 'Carte non enregistrée', es: 'Tarjeta no registrada', de: 'Karte nicht registriert', it: 'Tessera non registrata', pt: 'Cartão não registado' },
    },
    {
      key: 'track_finished',
    ...
    },
    {
      ...
      charLimit: 50,
      seed: { en: 'Card playable again in {{n}} min', fr: 'Carte rejouable dans {{n}} min', es: 'Tarjeta disponible en {{n}} min', de: 'Karte in {{n}} Min wieder spielbar', it: 'Tessera riutilizzabile tra {{n}} min', pt: 'Cartão jogável em {{n}} min' },
    },
  ],
  ingame_tagquest: [
