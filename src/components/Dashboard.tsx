...
import { LogOut, Home, Users, Settings, FileText, Code, Film, TrendingUp, Image, Shield, Activity, Zap, Package, Clock, CreditCard, LayoutGrid as Layout } from 'lucide-react';
